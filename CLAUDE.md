...
└── wechat-mp-writer-skill/  # WeChat article writing assistant
...
└── architect-plugin/    # Software architect toolkit
    ...
    │   └── api-design/
    └── agents/
        └── software-architect.md  # Architect agent
```
...
- **Skills**: 17 PM skills covering daily workflow, specialized capabilities, healthcare domain, and professional growth.
